...
PATH_TO_GENERATED    = 'generated.txt'
...
tweet_text = markov.generate_n_sentences(2)

# Truncate output to under 140 characters
tweet = cleanup tweet_text.match(/^.{0,140}\b/)[0]
